"""
Text Analysis Metrics for Charts and Statistics
Provides word count, sentence count, and complex word analysis for visualizations
"""
...
def calculate_all_metrics(text):
    """Calculate text statistics for charts and analysis"""
...
def generate_clause_type_chart(clause_type_summary):
    """Generate clause type distribution doughnut chart using matplotlib/seaborn"""
    try:
...
def generate_stats_chart(original_metrics, simplified_metrics):
    """Generate text statistics comparison bar chart using matplotlib/seaborn"""
    try:
